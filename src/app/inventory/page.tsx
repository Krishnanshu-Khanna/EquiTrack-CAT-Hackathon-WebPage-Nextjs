	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			const res = await fetch(
				process.env.NEXT_PUBLIC_BACKEND_API + "/api/operators",
				{
					method: "POST",
			...
			// Add new equipment to list (simulate id, engineHours, status)
			setEquipment([
				...equipment,
				{
				...
				<Card>
						...
						<Table>
							<TableHeader>
								<TableRow>
									...
									<TableHead className='hidden md:table-cell'>Engine Hours</TableHead>
									<TableHead>
					...
					<CardFooter>
						<div className='text-xs text-muted-foreground'>
							Showing <strong>1-{equipment.length}</strong> of{" "}
